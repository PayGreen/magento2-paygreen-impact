...
/**
 * Class TreeContributionPictureOfficer
 * @package PGMagentoTree\Services\Officers
 */
class TreeContributionPictureOfficer extends AbstractService
{
    /** @var Pathfinder */
    private $pathFinder;
    ...
    {
        $this->log()->debug('Install tree contribution image.');
    ...
    {
        $sourceFile = $this->pathFinder->toAbsolutePath($this->getConfig('contribution_picture'));
