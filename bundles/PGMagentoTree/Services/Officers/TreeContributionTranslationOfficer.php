...
/**
 * Class TreeContributionTranslationOfficer
 * @package PGMagentoTree\Services\Officers
 */
class TreeContributionTranslationOfficer extends AbstractService
{
    ...
    {
        $this->log()->debug("Install climate contribution translations.");
    ...
    {
        $this->log()->debug("Install tree contribution translation for StoreView #{$localStoreView->getId()}.");

        $name = $this->translator->get(
            $this->getConfig('contribution_name_translation_key'),
